...
public class RecStudyAb {
	...
	private String recStudyAbReason;		//추천이유
	private String recStudyAbContent;		//내용 및 절자
	private String recStudyAbCondition;		//구분(상태)
	private String recStudyAbRegisterDate;	//적용년도
}
