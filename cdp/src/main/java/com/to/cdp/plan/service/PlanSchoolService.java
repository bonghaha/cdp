...
public class PlanSchoolService {
	...
	public int planSchoolDetailInsert(PlanSchoolDetail planSchoolDetail) {
		...
		planSchoolDetailLastKey = planSchoolDao.planSchoolDetailLastKey();
		...
		return planSchoolDao.planSchoolDetailInsert(planSchoolDetail);
	}

	public List<PlanSchoolDetail> planSchoolDetailList(PlanSchoolDetail planSchoolDetail) {
		return planSchoolDao.planSchoolDetailList(planSchoolDetail);
