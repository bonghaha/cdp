...
public class PlanSchoolController {
	...
	public List<PlanSchoolDetail> planSchoolDetailList(
		...
		planSchoolDetailList = planSchoolService.planSchoolDetailList(planSchoolDetail);	//planSchoolCode에 해당하는 거 리스트 뽑기
	...
	public void planSchoolDetailInsert(
		...
		planSchoolDetail.setInfoMemberId((String) session.getAttribute("memberLoginId"));
		planSchoolService.planSchoolDetailInsert(planSchoolDetail);
	}
